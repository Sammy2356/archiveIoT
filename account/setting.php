...
if (isset($_SESSION["is_logged_in"]) && $_SESSION["is_logged_in"] && isset($_SESSION["user"]) && is_array($_SESSION["user"]) && count($_SESSION["user"]) == 8) {
    ...
    if (isset($_POST["btnChangePassword"])) {
        ...
        if ($controller->getPasswordComparism($_SESSION["user"]["user_password"], $old)) {
            $payload = array(
                '_password' => $new,
...
<head>
    ...
    <title>Account Setting - ArchiveIot</title>
            ...
            <section id="profile">
                <form action="" method="post" enctype="multipart/form-data">
                    <div id="picture_frame">
                        <img src="<?php echo Helper::loadImage($_SESSION["user"]["user_picture"]); ?>" alt="">
                        <label class="upload_image" for="picture">+</label>
                        <input hidden type="file" name="picture" id="picture">
                    </div>
                    <button type="submit" style="display: none; margin: 5px auto 0px auto;" name="uploadPicture" id="uploadPicture">Upload Image</button>
                </form>
            </section>
            ...
            <section id="change_password">
                ...
                <form action="" method="post">
                    <div class="formControl">
                        <input type="password" placeholder="Enter current password" name="old" id="old" required minlength="6">
                    </div>
                    <div class="formControl">
                        <input type="text" placeholder="Enter new password" name="new" id="new" required minlength="6">
                    </div>

                    <div class="formControl">
                        <button type="submit" name="btnChangePassword">Change password</button>
                    </div>
                </form>
            </section>
